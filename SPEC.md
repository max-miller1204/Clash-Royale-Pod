...
_Wave 2E executed 2026-05-02 on branch swarm/finish-project-wave-2e-hp-bar-reader; chunks 2e-hp-bar-reader (replaced tesseract digit OCR with HSV-mask HP-bar pixel sampling; brev A6000 smoke 30 replays / 98 min / ~$1: drop rate 100% → 34%, kept 310/467 interactions, holdout MAE 463.20, Spearman -0.037, per_card_stats populated for 7 cards). Pipeline is end-to-end functional; EV signal weak on 234 train rows — wave 3 can proceed against real per_card_stats but blunder calls will be noisy until train fold expands. PR pending._
